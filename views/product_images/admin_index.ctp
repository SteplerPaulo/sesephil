<div class="productImages index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php  echo $html->image('product images' . DS .'thumb'. DS . 'small' . DS . $productImage['ProductImage']['img_file'], array('alt' => 'Gallery Image')); ?></td>
		
		<td><?php echo $productImage['ProductImage']['caption']; ?>&nbsp;</td>
		<td class="actions">
